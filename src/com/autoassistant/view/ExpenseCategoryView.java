...
public class ExpenseCategoryView extends View {
	...
	public ExpenseCategoryView(final Entity entity) {
		super(entity);
	}
	...
	protected void init() {
		...
		tfExpenseCategory = addTextField("Expense category", ((ExpenseCategory) entity).getName(), 0, 32, 380, 32);
		setPreferredSize(new Dimension(380, 70));
	}

	@Override
	public void updateObject() {
		((ExpenseCategory) entity).setName(tfExpenseCategory.getText());		
	}
